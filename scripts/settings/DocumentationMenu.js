...
const DOCUMENTATION_MENU_KEY = `${Constants.MODULE_ID}.${SETTINGS_KEYS.DOCUMENTATION_MENU}`;
...
export class DocumentationMenu extends ApplicationV2 {
  ...
  static bindSettingsButton(html) {
    ...
    for (const candidate of candidates) {
      candidate.classList.add("sc-ma-docs-setting-row");
      ...
      button.classList.add("sc-ma-docs-button");
      if (button.dataset.scMaDocsBound === "true") {
        continue;
      }

      button.dataset.scMaDocsBound = "true";
